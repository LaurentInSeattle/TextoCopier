...
/// <summary> Interface implemented by all custom behaviors. </summary>
public interface IBehavior
{
    /// <summary> Gets the <see cref="AvaloniaObject"/> to which the <seealso cref="IBehavior"/> is attached. </summary>
