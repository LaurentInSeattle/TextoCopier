...
/// <summary> Avalonia Matrix helper methods. </summary>
public static class MatrixHelper
{
    ...
    public static Matrix Translate(double offsetX, double offsetY) =>  new(1.0, 0.0, 0.0, 1.0, offsetX, offsetY);

    /// <summary> Prepends a translation around the center of provided matrix. </summary>
    /// <param name="matrix">The matrix to prepend translation.</param>
    /// <param name="offsetX">X-coordinate offset.</param>
    /// <param name="offsetY">Y-coordinate offset.</param>
    /// <returns>The created translation matrix.</returns>
    public static Matrix TranslatePrepend(Matrix matrix, double offsetX, double offsetY) => Translate(offsetX, offsetY) * matrix;

    /// <summary> Creates a matrix that scales along the x-axis and y-axis. </summary>
    ...
    public static Matrix Scale(double scaleX, double scaleY) => new (scaleX, 0, 0, scaleY, 0.0, 0.0);

    /// <summary> Creates a matrix that is scaling from a specified center. </summary>
    /// <param name="scaleX">Scaling factor that is applied along the x-axis.</param>
    /// <param name="scaleY">Scaling factor that is applied along the y-axis.</param>
    ...
    /// <summary> Prepends a scale around the center of provided matrix. </summary>
    ...
    public static Matrix ScaleAtPrepend(Matrix matrix, double scaleX, double scaleY, double centerX, double centerY)
        => ScaleAt(scaleX, scaleY, centerX, centerY) * matrix;

    /// <summary> Creates a translation and scale matrix using the specified offsets and scales along the x-axis and y-axis. </summary>
    /// <param name="scaleX">Scaling factor that is applied along the x-axis.</param>
    /// <param name="scaleY">Scaling factor that is applied along the y-axis.</param>
    /// <param name="offsetX">X-coordinate offset.</param>
    /// <param name="offsetY">Y-coordinate offset.</param>
    ...
    /// <summary> Creates a skew matrix. </summary>
    ...
    public static Matrix Skew(float angleX, float angleY) =>  new (1.0, Tan(angleX), Tan(angleY), 1.0, 0.0, 0.0);

    /// <summary> Creates a matrix that rotates. </summary>
    ...
    /// <summary> Creates a matrix that rotates about a specified center. </summary>
    ...
    /// <summary> Transforms a point by this matrix. </summary>
