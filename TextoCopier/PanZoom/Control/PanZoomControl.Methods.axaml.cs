...
public partial class PanZoomControl
{
    /// <summary> Do an animated zoom to view a specific scale and rectangle (in content coordinates). </summary>
    ...
    /// <summary> Do an animated zoom to the specified rectangle (in content coordinates). </summary>
    ...
    /// <summary> Instantly zoom to the specified rectangle (in content coordinates). </summary>
    ...
    /// <summary> Instantly center the view on the specified point (in content coordinates). </summary>
    ...
    /// <summary> Use animation to center the view on the specified point (in content coordinates). </summary>
    ...
    /// <summary> Do animation that scales the content so that it fits completely in the control. </summary>
