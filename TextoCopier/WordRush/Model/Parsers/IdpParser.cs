...
public sealed class IdpParser : Parser
{
    ...
    public IdpParser(FileManagerModel fileManager, Language language) : base(fileManager, language) { }

    public static WordTranslator Load (FileManagerModel fileManager, Language target, string file)
    {
        var parser = new IdpParser(fileManager, target);
        string[] lines = parser.Load(file);
