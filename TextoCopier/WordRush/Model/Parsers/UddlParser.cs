...
{
    public UddlParser(FileManagerModel fileManager, Language language) : base(fileManager, language) => tags = new HashSet<string>();

    public static WordTranslator Load(FileManagerModel fileManager, Language language, string file)
    {
        var parser = new UddlParser(fileManager, language);
        string[] strings = parser.Load(file);
    ...
    private string[] Load(string name)
    {
        ...
        string folder = "Uddl";
        string uriSource = this.ResourceUriString(folder, name);
        string content = this.LoadTextResource(uriSource);
